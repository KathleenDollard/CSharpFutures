...
namespace CSharp7
{
    class Program
    {
        ...
        public static TEnum Foo<TEnum, TDelegate>(
            TDelegate del, string value1, string value2)
            where TEnum : Enum
